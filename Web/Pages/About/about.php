  ...
  <body>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <!-- The First slide (le doyen slide contient l'image et le nome est les information de doyen) -->

          <div class="carousel-item active">
            <div class="card mb-3 container" style="max-width: 1000px;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                      <img src="lelouch.jpg" class="card-img" alt="...">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body">
          ...
          <!-- The Secend slide (fpt slide contient les information de faculté) -->
