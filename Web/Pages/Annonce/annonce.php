...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="http://localhost/Departement-math-info/Web/Pages/Annonce/annonce.css">
</head>
<body>
  ...
  <div id="ancSlide" class="carousel slide slide-annonce" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="annonce_container">
          <div class="cover">
            <img src="http://localhost/Departement-math-info/Web/Pages/Annonce/img.jpg" alt="">
          </div>
    ...
    <a class="carousel-control-prev" href="#ancSlide" role="button" data-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#ancSlide" role="button" data-slide="next">
